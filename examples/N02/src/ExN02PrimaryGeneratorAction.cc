...
//
//
// $Id: ExN02PrimaryGeneratorAction.cc,v 1.2 2017/12/17 11:11:59 arce Exp $
//
...
{ 
  G4LogicalVolume* worldLV = GmGeometryUtils::GetInstance()->GetLogicalVolumes("World")[0];
  G4Box* worldBox = (G4Box*)(worldLV->GetSolid());
  G4double position = -0.5*(worldBox->GetZHalfLength());
