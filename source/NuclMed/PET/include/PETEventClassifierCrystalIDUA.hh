#ifndef PETEventClassifierCrystalIDUA_H
#define PETEventClassifierCrystalIDUA_H
...
class PETEventClassifierCrystalIDUA : public GmUserEventAction,
			     public GmUserRunAction
{

public:
  PETEventClassifierCrystalIDUA();
  virtual ~PETEventClassifierCrystalIDUA();
