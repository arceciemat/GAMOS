#ifndef DetVComptClassificationVariable_H
#define DetVComptClassificationVariable_H
...
public:
  DetVComptClassificationVariable();
  virtual ~DetVComptClassificationVariable(){};
  void InitVariables();
