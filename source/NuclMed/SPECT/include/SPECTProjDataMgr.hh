...
#ifndef SPECTProjDataMgr_h
#define SPECTProjDataMgr_h

/*---------------------------------------------------------------------------  
ClassName:   SPECTProjDataMgr
...
//------------------------------------------------------------------------
class SPECTProjDataMgr : public GmIObinMgr
{ 
 private:
  SPECTProjDataMgr();
 ...
 public:
  ...
  static SPECTProjDataMgr* GetInstance();
...
private:
  static SPECTProjDataMgr* theInstance;
