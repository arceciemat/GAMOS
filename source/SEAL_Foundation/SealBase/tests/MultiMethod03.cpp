...
MMM_DEFUN_FUNC(int,::,confound,(U *, X *)) { seal_test::out << "[confound (U *, X *)]"; return 0; }
...
int seal_test::MultiMethod03(int argc, char **argv)
{
    ...
    seal_test::out << "(u, x) -> " << confound (&u, &x) << std::endl;
