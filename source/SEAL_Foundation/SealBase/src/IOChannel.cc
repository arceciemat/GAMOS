...
// FIXME: auto close on delete flag?
// FIXME: ASSERT (IsValidAddress (pBuf, nCount)); in lots of places
...
IOChannel::IOChannel (IOFD fd /* = IOFD_INVALID */)
    : m_fd (fd)
{}
