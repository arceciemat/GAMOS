#ifndef SEAL_BASE_MULTIMETHOD_H
# define SEAL_BASE_MULTIMETHOD_H

//<<<<<< INCLUDES                                                       >>>>>>

# include "SealBase/XTypeInfo.h"
# include "SealBase/PODVector.h"
