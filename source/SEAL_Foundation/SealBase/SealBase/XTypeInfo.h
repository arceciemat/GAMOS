#ifndef SEAL_BASE_XTYPEINFO_H
# define SEAL_BASE_XTYPEINFO_H
...
#  define xtypeid(arg)		(seal::XTypeInfo::find (typeid (arg)))
...
#  define xtypedata(arg)	(&seal::XTypeInfoData<arg>::s_type)
...
#  define XTYPEINFO_DECLARE(api,type)					\
    namespace seal {						\
      template <> struct api XTypeInfoData< :: type> {			\
        static XTypeInfo::ClassDef	s_type;				\
        static XTypeInfo::BaseDef	s_bases[];			\
        static XTypeInfoInit< :: type>	s_init;				\
      };								\
    }

#  define XTYPEINFO_PDEF_0(type)						\
    seal::XTypeInfo::BaseDef seal::XTypeInfoData< type >::s_bases [] = {\
	{ 0, 0, 0, 0, 0 },							\
    };										\
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
...
#  define XTYPEINFO_DEF_0(type)							\
    ...
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
	{ 0, &s_bases[0], &s_bases[0], 0, 0, 0, 0, 0 };				\
    seal::XTypeInfoInit< type > seal::XTypeInfoData< type >::s_init (&s_type, s_bases)


#  define XTYPEINFO_PDEF_1(type,base1,mode1)					\
    seal::XTypeInfo::BaseDef seal::XTypeInfoData< type >::s_bases [] = {\
	{ 1, &seal::XTypeInfoData< base1 >::s_type, mode1,			\
	  0 /*&seal::XTypeInfoCast< type,base1 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base1 >::up*/},			\
	{ 0, 0, 0, 0, 0 },							\
    };										\
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
...
#  define XTYPEINFO_PDEF_2(type,base1,mode1,base2,mode2)			\
	...
	{ 1, &seal::XTypeInfoData< base1>::s_type, mode1,			\
	  0 /*&seal::XTypeInfoCast< type,base1 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base1 >::up*/},			\
	{ 1, &seal::XTypeInfoData< base2 >::s_type, mode2,			\
	  0 /*&seal::XTypeInfoCast< type,base2 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base2 >::up*/},			\
	{ 0, 0, 0, 0, 0 },							\
    };										\
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
...
#  define XTYPEINFO_PDEF_3(type,base1,mode1,base2,mode2,base3,mode3)		\
	...
	{ 1, &seal::XTypeInfoData< base2 >::s_type, mode2,			\
	  0 /*&seal::XTypeInfoCast< type,base2 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base2 >::up*/},			\
	{ 1, &seal::XTypeInfoData< base3 >::s_type, mode3,			\
	  0 /*&seal::XTypeInfoCast< type,base3 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base3 >::up*/},			\
	{ 0, 0, 0, 0, 0 },							\
    };										\
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
...
#  define XTYPEINFO_PDEF_4(type,base1,mode1,base2,mode2,base3,mode3,base4,mode4)\
	...
	{ 1, &seal::XTypeInfoData< base3 >::s_type, mode3,			\
	  0 /*&seal::XTypeInfoCast< type,base3 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base3 >::up*/},			\
	{ 1, &seal::XTypeInfoData< base4 >::s_type, mode4,			\
	  0 /*&seal::XTypeInfoCast< type,base4 >::down*/,			\
	  0 /*&seal::XTypeInfoCast< type,base4 >::up*/},			\
	{ 0, 0, 0, 0, 0 },							\
    };										\
    seal::XTypeInfo::ClassDef seal::XTypeInfoData< type >::s_type =	\
...
inline
XTypeInfo::TypeIterator::TypeIterator (TypeTable::const_iterator iterator2)
    : m_iterator (iterator2)
{}
