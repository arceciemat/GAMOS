#ifndef SEAL_BASE_IO_SELECTOR_H
# define SEAL_BASE_IO_SELECTOR_H
...
public:
    ...
    SEAL_BASE_API static const Strategy SV_DEFAULT [];

    /** Default high-load strategy vector.  */
    SEAL_BASE_API static const Strategy SV_HIGHPERF [];
