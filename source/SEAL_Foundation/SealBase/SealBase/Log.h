#ifndef SEAL_BASE_LOG_H
# define SEAL_BASE_LOG_H

//<<<<<< INCLUDES                                                       >>>>>>

# include "SealBase/Macros.h"
# include "SealBase/DebugAids.h"
# include "SealBase/iosfwd.h"
# include <string>
...
#  define LOG(level,what,mode,v) seal::logstream::what (mode,level) << v
...
SEAL_BASE_API extern logflag LFall;

/** Pseudo log mode that excludes everything else.  */
SEAL_BASE_API extern logflag LFnever;

/** Log mode for general messages.  */
SEAL_BASE_API extern logflag LFgeneral;

/** Log mode for memory-management messages.  */
SEAL_BASE_API extern logflag LFmemory;

/** Log mode for assertion failure messages.  */
SEAL_BASE_API extern logflag LFassert;

/** Log mode for exception handling messages.  */
SEAL_BASE_API extern logflag LFexception;

/** Log mode for signal handling messages.  */
SEAL_BASE_API extern logflag LFsignal;

/** Log mode for I/O messages.  */
SEAL_BASE_API extern logflag LFio;

/** Log mode for application initialisation messages.  */
SEAL_BASE_API extern logflag LFinit;

/** Log mode for application closure messages.  */
SEAL_BASE_API extern logflag LFexit;

/** Log mode for networking messages.  */
SEAL_BASE_API extern logflag LFnet;
