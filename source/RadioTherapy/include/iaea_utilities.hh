...
#endif
//GAMOS #ifdef MAIN
//GAMOS int eprintf_mode = ON;
//GAMOS #else
//GAMOS extern int eprintf_mode;
//GAMOS #endif
// GAMOS#ifndef MAIN
// GAMOS extern /* create global pbuffer */
// GAMOS #endif          
// GAMOS char *pbuffer;  /* pointer to buffer for output of run info for failures */
...
//GAMOS #define min(a,b)    (((a) < (b)) ? (a) : (b))
//GAMOS #define max(a,b)    (((a) > (b)) ? (a) : (b))
//#define __max       max
//#define __min       min
...
// GAMOS void allocate_pbuffer(void);
