...
void GmGenerDistPositionDirection2DCorrelDoubleGaussian::SetParamsEnergy( G4String energy )
{
  ...
  G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussian::SetParamsEnergy " << theConfFileNamePrefix+energy << G4endl;
  
  std::vector<G4String> params;
  fin.GetWordsInLine(params);
  fin.Close();
  G4cout << "aa GmGenerDistPositionDirection2DCorrelDoubleGaussian::SetParamsEnergy NPARAM " << params.size() << G4endl;
