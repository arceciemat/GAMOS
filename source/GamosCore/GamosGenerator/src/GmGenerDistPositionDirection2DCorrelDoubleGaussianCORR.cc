...
#define _USE_MATH_DEFINES
#include <cmath>
#include "GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR.hh"
...
#endif
G4bool GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms = false;

//---------------------------------------------------------------------
GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR()
{
  theCentre = G4ThreeVector(0., 0., 0.);

#ifdef HISTOGRAMS
  bHistogramsHere = true;
  if( !GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms ) {
    bHistogramsHere = false;
  }
  if( GmParameterMgr::GetInstance()->GetNumericValue("GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR:Histograms",1) == 0 ) {
    bHistogramsHere = false; //GDEB
    bHistograms = false; //GDEB
  }
  //  G4cout << this << " CREATE bHistogramsHere " << bHistogramsHere << " " << GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms << G4endl; //GDEB
#endif

  theConfFileNamePrefix = GmParameterMgr::GetInstance()->GetStringValue("GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR:ConfFileNamePrefix","confE");
}

//---------------------------------------------------------------------
G4ThreeVector GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GeneratePosition( GmParticleSource* partSource )
{
  ...
  if( GenerVerb(debugVerb) ) G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GeneratePosition POS= " << thePosition << " DIR= " << theDirection << " " << bX1 << " " << bY1 << G4endl;
#endif
  thePosition = theRotation * thePosition;
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GeneratePosition POS_afterROT= " << thePosition << G4endl;
#endif

#ifdef HISTOGRAMS
  //  G4cout << this <<" " << bHistogramsHere <<" FILL GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms = " << GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms << G4endl; //GDEB
  if( bHistogramsHere ) {
...
//---------------------------------------------------------------------
G4ThreeVector GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GenerateDirection( GmParticleSource* partSource )
{
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) G4cout << partSource << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::GenerateDirection " << partSource->GetDirection() << G4endl;
#endif
...
//---------------------------------------------------------------------
void GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParams( const std::vector<G4String>& params )
{
  
  if( params.size() != 16 && params.size() != 19 && params.size() != 22 ) {
    G4Exception(" GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParams",
		"Wrong argument",
  ...
  //  G4cout << this << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms = " << GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms << G4endl; //GDEB
  GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::bHistograms = false;
#endif
...
//---------------------------------------------------------------------
void GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParamsEnergy( G4String energy )
{
  ...
  //  G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParamsEnergy " << theConfFileNamePrefix+energy << G4endl; //GDEB
  
  std::vector<G4String> params;
  fin.GetWordsInLine(params);
  fin.Close();
  //  G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParamsEnergy NPARAM " << params.size() << G4endl; //GDEB

  SetParams(params);
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) {
    G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetParamsEnergy " << G4endl;
...
//---------------------------------------------------------------------
void GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetDirection( G4ThreeVector dir )
{
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetDirection " << dir << G4endl;
#endif
  ...
  if( dirDist && dirDist->GetParticleSource() ) {
    ...
    GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR* posDistDG = dynamic_cast<GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR*>(posDist);
...
//---------------------------------------------------------------------
void GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetRotation( G4RotationMatrix& rotm )
{
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) G4cout << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetRotation " << rotm << G4endl;
#endif
...
//---------------------------------------------------------------------
void GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetCentre( G4ThreeVector pos )
{
#ifndef GAMOS_NO_VERBOSE
  if( GenerVerb(debugVerb) ) G4cout << theCorrelGaussianX1Y1 << " GmGenerDistPositionDirection2DCorrelDoubleGaussianCORR::SetCentre " << pos << G4endl;
#endif
