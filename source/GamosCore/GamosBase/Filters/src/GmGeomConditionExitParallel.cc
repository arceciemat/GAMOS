...
const G4VTouchable* GmGeomConditionExitParallel::GetTouchableFromTrack(const G4Track* aTrack)
{
  ...
  if( BaseVerb(debugVerb) ) G4cout << " GmGeomConditionExitParallel::GetTouchableFromTrack " << G4endl;
#endif
...
#ifndef GAMOS_NO_VERBOSE
	if( BaseVerb(debugVerb) ) G4cout << " GmGeomConditionExitParallel::GetTouchableFromTrack return touchable " << preSP->GetPhysicalVolume()->GetName() << G4endl;
#endif
...
#ifndef GAMOS_NO_VERBOSE
  if( BaseVerb(debugVerb) ) G4cout << " GmGeomConditionExitParallel::GetTouchableFromTrack return 0 " << G4endl;
#endif
...
{
#ifndef GAMOS_NO_VERBOSE
  if( BaseVerb(debugVerb) ) G4cout << " GmGeomConditionExitParallel::GetTouchableFromStep return touchable " << G4endl;
#endif
...
#ifndef GAMOS_NO_VERBOSE
    if( BaseVerb(debugVerb) ) G4cout << " GmGeomConditionExitParallel::GetTouchableFromStep return 0, status " << preSP->GetStepStatus() << G4endl;
#endif
    return 0;
  } else {
#ifndef GAMOS_NO_VERBOSE
