...
//------------------------------------------------------------------
G4int GmClassifierByCreatorProcess::GetIndexFromStep(const G4Step* aStep)
{
  G4int index;
  ...
  if( BaseVerb(debugVerb) ) G4cout << " GmClassifierByCreatorProcess::GetIndexFromStep " << index << " proc " << procName << G4endl;
#endif
...
//------------------------------------------------------------------
G4int GmClassifierByCreatorProcess::GetIndexFromTrack(const G4Track* aTrack)
{
  G4int index;
...
#ifndef GAMOS_NO_VERBOSE
  if( BaseVerb(debugVerb) ) G4cout << " GmClassifierByCreatorProcess::GetIndex " << index << " proc " << procName << G4endl;
#endif
...
//--------------------------------------------------------------
G4String GmClassifierByCreatorProcess::GetIndexName(G4int index)
{
