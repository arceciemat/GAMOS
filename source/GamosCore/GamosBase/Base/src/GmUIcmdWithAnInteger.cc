...
#include "GmUIcmdWithAnInteger.hh"

// --------------------------------------------------------------------
GmUIcmdWithAnInteger::GmUIcmdWithAnInteger(const char* theCommandPath,
...
// --------------------------------------------------------------------
G4int GmUIcmdWithAnInteger::GetNewIntValue(const char* paramString)
{
  return ConvertToInt(paramString);
}

// --------------------------------------------------------------------
void GmUIcmdWithAnInteger::SetParameterName(const char* theName,
                                            G4bool omittable,
...
// --------------------------------------------------------------------
void GmUIcmdWithAnInteger::SetDefaultValue(G4int defVal)
{
  G4UIparameter* theParam = GetParameter(0);
