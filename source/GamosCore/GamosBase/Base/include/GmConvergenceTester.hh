...
//
//
// $Id: GmConvergenceTester.hh,v 1.5 2018/06/28 15:26:54 arce Exp $
// GEANT4 tag $Name:  $
//
// Class description:
//
...
// 
// Small changes for GAMOS: Pedro Arce
// --------------------------------------------------------------------

#ifndef GmConvergenceTester
#define GmConvergenceTester_h 1
...
class GmConvergenceTester 
{
   public:
      ...
      GmConvergenceTester(G4String name);
     ~GmConvergenceTester();
      GmConvergenceTester( G4double );
   ...
   private:
      ...
      G4int noBinOfPDF;
      G4SimplexDownhill<GmConvergenceTester>* minimizer;
