...
#ifndef GmG4PSCellCharge_h
#define GmG4PSCellCharge_h 1
...
class GmG4PSCellCharge : public GmVPrimitiveScorer
{
   public: // with description
      GmG4PSCellCharge(G4String name);
      virtual ~GmG4PSCellCharge();
