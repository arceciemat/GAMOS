...
//--------------------------------------------------------------------
GmPSLETBydEdxPhi::GmPSLETBydEdxPhi(G4String name) 
...
//--------------------------------------------------------------------
G4bool GmPSLETBydEdxPhi::ProcessHits(G4Step* aStep,G4TouchableHistory* th)
{
...
//--------------------------------------------------------------------
void GmPSLETBydEdxPhi::SetParameters( const std::vector<G4String>& params)
{ 
  if( params.size() != 0 ){
    G4String parastr;
    ...
    G4Exception("GmPSLETBydEdxPhi::SetParameters",
