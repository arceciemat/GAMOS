...
//--------------------------------------------------------------------
GmPSLETByESpectPhi::GmPSLETByESpectPhi(G4String name) 
...
//--------------------------------------------------------------------
G4bool GmPSLETByESpectPhi::ProcessHits(G4Step* aStep,G4TouchableHistory* th)
{
...
//--------------------------------------------------------------------
void GmPSLETByESpectPhi::SetParameters( const std::vector<G4String>& params)
{ 
  if( params.size() != 0 ){
    G4String parastr;
    ...
    G4Exception("GmPSLETByESpectPhi::SetParameters",
