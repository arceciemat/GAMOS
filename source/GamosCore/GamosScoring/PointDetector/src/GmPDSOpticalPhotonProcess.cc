...
//------------------------------------------------------------------
GmPDSOpticalPhotonProcess::GmPDSOpticalPhotonProcess(const G4String& name, G4SteppingManager* fpSM ): GmPDSVProcess( name, fpSM)
{
...
//------------------------------------------------------------------
GmPDSOpticalPhotonProcess::~GmPDSOpticalPhotonProcess()
{
}


//------------------------------------------------------------------
void GmPDSOpticalPhotonProcess::AddHelper( GmPDSProcessHelper* helper )
{
