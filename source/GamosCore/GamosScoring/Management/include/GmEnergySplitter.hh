...
// ********************************************************************
//
#ifndef GmEnergySplitter_h
#define GmEnergySplitter_h 1
...
class GmEnergySplitter 
{
public: // with description
  GmEnergySplitter();
  virtual ~GmEnergySplitter();
  ...
  inline void GetLengthAndEnergyDeposited( G4int stepNo, G4int& voxelID, G4double& stepLength, G4double &energyDepo);
