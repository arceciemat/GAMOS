#ifndef GmG4PSDoseDeposit_old_hh
#define GmG4PSDoseDeposit_old_hh 1
...
class GmG4PSDoseDeposit_old : public GmVPrimitiveScorer
{
  friend class G4MultiFunctionalDetector;
  
public: // with description
  GmG4PSDoseDeposit_old(G4String name);
  virtual ~GmG4PSDoseDeposit_old(){ };
