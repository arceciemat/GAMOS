...
//------------------------------------------------------------------------------
G4double GmComputeDEDX::GetElectronicELoss(G4Step* aStep, G4bool bRestricted)
{ 
  G4double let = GetElectronicDEDX( aStep, bRestricted);
...
//------------------------------------------------------------------------------
G4double GmComputeDEDX::GetElectronicDose(G4Step* aStep, G4bool bRestricted)
{
  ...
  G4double eeLoss = GetElectronicELoss( aStep, bRestricted );
  G4double eDose  = eeLoss / ( density * volume );
