...
//--------------------------------------------------------------------
GmPSLETEDepPhi::GmPSLETEDepPhi(G4String name) 
...
//--------------------------------------------------------------------
G4bool GmPSLETEDepPhi::ProcessHits(G4Step* aStep,G4TouchableHistory* th)
{
...
//--------------------------------------------------------------------
void GmPSLETEDepPhi::SetParameters( const std::vector<G4String>& params)
{ 
  if( params.size() != 0 ){
    G4String parastr;
    ...
    G4Exception("GmPSLETEDepPhi::SetParameters",
