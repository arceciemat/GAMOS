...
//----------------------------------------------------------------
GmDataInitialTouchablePosZ::GmDataInitialTouchablePosZ()
{
}
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosZ::GetValueFromStep( const G4Step* aStep, G4int )
{
  ...
  return centreGlobal.z();

}

/*//----------------------------------------------------------------
G4double GmDataInitialTouchablePosZ::GetValueFromTrack( const G4Track* aTrack, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosZ::GetValueFromSecoTrack( const G4Track* aTrack1 , const G4Track* aTrack2, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosZ::GetValueFromEvent( const G4Event* anEvent, G4int )
{
