...
//----------------------------------------------------------------
GmDataFinalLocalInPrePosPhi::GmDataFinalLocalInPrePosPhi()
{
  bInitial = false;
  theHMin = -180.;
  theHMax = 180.;
...
//----------------------------------------------------------------
G4double GmDataFinalLocalInPrePosPhi::GetValueFromStep( const G4Step* aStep, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataFinalLocalInPrePosPhi::GetValueFromTrack( const G4Track* aTrack, G4int )
{
