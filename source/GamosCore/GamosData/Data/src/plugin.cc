...
PLUGINSVC_FACTORY(GmDataInitialMeanIoniPot,GmVData*())
PLUGINSVC_FACTORY(GmDataFinalMeanIoniPot,GmVData*())
...
DEFINE_GAMOS_DATA(GmDataInitialMeanIoniPot);
DEFINE_GAMOS_DATA(GmDataFinalMeanIoniPot);
