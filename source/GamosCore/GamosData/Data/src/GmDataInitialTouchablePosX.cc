...
//----------------------------------------------------------------
GmDataInitialTouchablePosX::GmDataInitialTouchablePosX()
{
}
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosX::GetValueFromStep( const G4Step* aStep, G4int )
{
  ...
  return centreGlobal.x();

}

/*//----------------------------------------------------------------
G4double GmDataInitialTouchablePosX::GetValueFromTrack( const G4Track* aTrack, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosX::GetValueFromSecoTrack( const G4Track* aTrack1 , const G4Track* aTrack2, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialTouchablePosX::GetValueFromEvent( const G4Event* anEvent, G4int )
{
