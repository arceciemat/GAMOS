...
//----------------------------------------------------------------
G4String GmDataInitialSolidType::GetStringValueFromStackedTrack( const G4Track* aTrack )
{ 
  return GetPVFromPos( aTrack->GetPosition() )->GetLogicalVolume()->GetSolid()->GetEntityType();
}
