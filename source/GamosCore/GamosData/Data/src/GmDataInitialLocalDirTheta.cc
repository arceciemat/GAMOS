...
//----------------------------------------------------------------
GmDataInitialLocalDirTheta::GmDataInitialLocalDirTheta()
{
  bInitial = true;
  theHMin = 0.;
  theHMax = 180.;
...
//----------------------------------------------------------------
G4double GmDataInitialLocalDirTheta::GetValueFromStep( const G4Step* aStep, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialLocalDirTheta::GetValueFromTrack( const G4Track* aTrack, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialLocalDirTheta::GetValueFromSecoTrack( const G4Track* aTrack1 , const G4Track* aTrack2, G4int )
{
...
//----------------------------------------------------------------
G4double GmDataInitialLocalDirTheta::GetValueFromEvent( const G4Event* anEvent, G4int )
{
