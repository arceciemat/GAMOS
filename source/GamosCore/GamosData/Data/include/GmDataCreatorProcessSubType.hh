#ifndef GmDataCreatorProcessSubType_hh
#define GmDataCreatorProcessSubType_hh

#include "GamosCore/GamosData/Management/include/GmVDataString.hh"

class GmDataCreatorProcessSubType : public GmVDataString
{
public:
  GmDataCreatorProcessSubType();
  ~GmDataCreatorProcessSubType();
