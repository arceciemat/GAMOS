...
//----------------------------------------------------------------
GmSecondaryTrackDataBinFileUA::GmSecondaryTrackDataBinFileUA()
{
  theDataType = DTSeco;
}

//----------------------------------------------------------------
void GmSecondaryTrackDataBinFileUA::BeginOfRunAction( const G4Run* )
{
  SetUserName( theName );
...
//----------------------------------------------------------------
void GmSecondaryTrackDataBinFileUA::UserSteppingAction(const G4Step* aStep )
{
...
//----------------------------------------------------------------
void GmSecondaryTrackDataBinFileUA::EndOfRunAction(const G4Run* )
{
  EndOfRun();
}
