...
//---------------------------------------------------------------------
GmNumericDistributionLogLin::GmNumericDistributionLogLin(G4String name)
...
//---------------------------------------------------------------------
G4double GmNumericDistributionLogLin::InterpolateValue(const G4double& indexVal, const G4double& indexDown, const G4double& indexUp, const G4double& valDown, const G4double& valUp )
{
  ...
  if( DistVerb(debugVerb) ) G4cout << " GmNumericDistributionLogLin::InterpolateValue " << value 
				   << " valDown= " << valDown << " valUp= " << valUp 
				   << " logIndexVal= " << log(indexVal)
