#ifndef GmGenerDistPositionNMImage_HH
#define GmGenerDistPositionNMImage_HH
...
class GmGenerDistPositionNMImage : public GmVGenerDistPosition
{
public:
  GmGenerDistPositionNMImage();
  virtual ~GmGenerDistPositionNMImage(){};
