...
GmPhysicsElectronLowEnerDeexSplit::GmPhysicsElectronLowEnerDeexSplit(const G4String& name): GmVPhysicsElectron(name)
{ }

GmPhysicsElectronLowEnerDeexSplit::~GmPhysicsElectronLowEnerDeexSplit()
{ }

void GmPhysicsElectronLowEnerDeexSplit::ConstructProcess()
{
