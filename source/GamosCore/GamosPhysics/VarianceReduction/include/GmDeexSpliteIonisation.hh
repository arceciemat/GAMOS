...
#ifndef GmDeexSpliteIonisation_h
#define GmDeexSpliteIonisation_h 1
...
class GmDeexSpliteIonisation : public GmVDeexSplitEnergyLossProcess
{

public:

  GmDeexSpliteIonisation(const G4String& name = "eIoni");

  virtual ~GmDeexSpliteIonisation();
...
private:
  ...
  GmDeexSpliteIonisation & operator=(const GmDeexSpliteIonisation &right);
  GmDeexSpliteIonisation(const GmDeexSpliteIonisation&);
