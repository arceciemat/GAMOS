...
#ifndef GmBOptnEWRayleigh_hh
#define GmBOptnEWRayleigh_hh 1

#include "GmVEWBiasingOperation.hh"
#include "G4ParticleChange.hh"


class GmBOptnEWRayleigh : public GmVEWBiasingOperation {
public:
  // -- Constructor :
  GmBOptnEWRayleigh(G4String name);
  // -- destructor:
  virtual ~GmBOptnEWRayleigh();
