...
#ifndef GmBOptnEWPhotoElectric_hh
#define GmBOptnEWPhotoElectric_hh 1

#include "GmVEWBiasingOperation.hh"
#include "G4ParticleChange.hh"


class GmBOptnEWPhotoElectric : public GmVEWBiasingOperation {
public:
  // -- Constructor :
  GmBOptnEWPhotoElectric(G4String name);
  // -- destructor:
  virtual ~GmBOptnEWPhotoElectric();
