...
#ifndef GmBOptnEWPairProduction_hh
#define GmBOptnEWPairProduction_hh 1

#include "GmVEWBiasingOperation.hh"
#include "G4ParticleChange.hh"


class GmBOptnEWPairProduction : public GmVEWBiasingOperation {
public:
  // -- Constructor :
  GmBOptnEWPairProduction(G4String name);
  // -- destructor:
  virtual ~GmBOptnEWPairProduction();
