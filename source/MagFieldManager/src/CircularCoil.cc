...
////////////////////////////////////////////////////////////////////////////////
//
CircularCoil::CircularCoil(G4double R,G4double dr, G4double dz,G4double current)
{ Radius = R;
  DR = dr;
  DZ = dz;
  I = current;
...
////////////////////////////////////////////////////////////////////////////////
//
void CircularCoil::GetFieldValue(const G4double yTrack[4],G4double *MagField) const
{ 
...
void CircularCoil::BCurrentloop(G4double a, G4double i,G4double rho, G4double z, G4double& Brho, G4double& Bz) const 
{ 
...
/////////////////////////////////////////////////////////////////////////////////////
//
void CircularCoil::SumOfLoops(G4int nr, G4int nz,G4double rho, G4double z, G4double& Brho, G4double& Bz) const
{ Brho=0.;
  Bz=0.;
  G4double icur;
  icur = I/(nr*nz);
