...
#ifndef CircularSolenoid_HH
#define CircularSolenoid_HH 1 
#include "G4Types.hh"
#include "G4ThreeVector.hh"
#include "G4MagneticField.hh"

class CircularSolenoid: public G4MagneticField
{
  public:  // with description

    CircularSolenoid(G4double R,G4double dr, G4double dz,G4double current);
    ~CircularSolenoid();
