...
GmVEmDNAPhysics::GmVEmDNAPhysics() 
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void GmVEmDNAPhysics::BuildDNAPhysics()
{
  // EM physics
...
void GmVEmDNAPhysics::ConstructParticle()
{
...
void GmVEmDNAPhysics::ConstructProcess()
{
...
void GmVEmDNAPhysics::SetCutForGamma(G4double cut)
{
  cutForGamma = cut;
...
void GmVEmDNAPhysics::SetCutForElectron(G4double cut)
{
  cutForElectron = cut;
...
void GmVEmDNAPhysics::SetCutForPositron(G4double cut)
{
  cutForPositron = cut;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool GmVEmDNAPhysics::ReplacePhysicsList(const G4String& name)
{
