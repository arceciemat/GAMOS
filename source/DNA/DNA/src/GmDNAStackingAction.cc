...
//
//
/// \file GmDNAStackingAction.cc
/// \brief Implementation of the GmDNAStackingAction class
...
GmDNAStackingAction::GmDNAStackingAction()
    : GmUserStackingAction()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void GmDNAStackingAction::NewStage()
{
    if(stackManager->GetNTotalTrack() == 0)
    {
#ifndef GAMOS_NO_VERBOSE
      if( DNAVerb(debugVerb) ) G4cout << "Physics stage ends" << G4endl;
#endif
        G4ITTransportationManager::GetTransportationManager()->
          SetWorldForTracking(
          G4ITTransportationManager::GetTransportationManager()->
  	  //-        GetParallelWorld("ChemistryWorld"));
          GetParallelWorld("world_parallel_1"));
