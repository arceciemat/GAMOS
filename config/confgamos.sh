...
#--- GEANT4 variables
export G4INSTALL=${GAMOSEXTERNAL}/geant4/geant4.10.06.p02.gamos
...
export G4PROTONHPDATA=$G4INSTALL/../data/G4TENDL1.3.2/Proton
export G4DEUTERONHPDATA=$G4INSTALL/../data/G4TENDL1.3.2/Deuteron
export G4TRITONHPDATA=$G4INSTALL/../data/G4TENDL1.3.2/Triton
export G4HE3HPDATA=$G4INSTALL/../data/G4TENDL1.3.2/He3
export G4ALPHAHPDATA=$G4INSTALL/../data/G4TENDL1.3.2/Alpha
...
#--- ROOT variables
export ROOT_BASE_DIR=${GAMOSEXTERNAL}/root/6.18.00/root
