...
#--- GEANT4 variables
setenv G4INSTALL ${GAMOSEXTERNAL}/geant4/geant4.11.01.p03.gamos
setenv G4TMP $GAMOSINSTALL/tmp
setenv G4BIN $GAMOSINSTALL/bin
setenv G4NEUTRONHPDATA $G4INSTALL/../data/G4NDL4.7
setenv G4LEDATA $G4INSTALL/../data/G4EMLOW8.5
setenv G4LEVELGAMMADATA $G4INSTALL/../data/PhotonEvaporation5.7
setenv G4RADIOACTIVEDATA $G4INSTALL/../data/RadioactiveDecay5.6
setenv G4PARTICLEXSDATA $G4INSTALL/../data/G4PARTICLEXS4.0
...
setenv G4ABLADATA $G4INSTALL/../data/G4ABLA3.3
setenv G4INCLDATA $G4INSTALL/../data/G4INCL1.2
...
#--- ROOT variables
setenv ROOT_BASE_DIR ${GAMOSEXTERNAL}/root/6.26.10/root
