...
// Note : Effects due to binding of atomic electrons are negliged.
{
  ...
  aGamma1 = new G4DynamicParticle (theGamma,Phot1Direction.unit(), Phot1Energy);
  ...
  aGamma2 = new G4DynamicParticle (theGamma,Phot2Direction.unit(), Phot2Energy);
  ...
  fParticleChange.AddSecondary(aGamma1);
  fParticleChange.AddSecondary(aGamma2);
