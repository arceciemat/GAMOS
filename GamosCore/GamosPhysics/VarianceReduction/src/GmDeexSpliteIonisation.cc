...
// ********************************************************************
//
// $Id: GmDeexSpliteIonisation.cc,v 1.3 2012/10/22 15:26:16 arce Exp $
// GEANT4 tag $Name:  $
//
// -------------------------------------------------------------------
//
...
//
//
// File name:     GmDeexSpliteIonisation
//
// Author:        Laszlo Urban
//
...
GmDeexSpliteIonisation::GmDeexSpliteIonisation(const G4String& name)
  : GmVDeexSplitEnergyLossProcess(name),
...
GmDeexSpliteIonisation::~GmDeexSpliteIonisation()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double GmDeexSpliteIonisation::MinPrimaryEnergy(const G4ParticleDefinition*,
					 const G4Material*,
					 G4double cut)
{
  G4double x = cut;
...
G4bool GmDeexSpliteIonisation::IsApplicable(const G4ParticleDefinition& p)
{
...
void GmDeexSpliteIonisation::InitialiseEnergyLossProcess(
...
void GmDeexSpliteIonisation::PrintInfo()
{}
