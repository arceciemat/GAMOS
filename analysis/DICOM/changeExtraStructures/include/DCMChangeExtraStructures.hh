#ifndef DCMChangeExtraStructures_hh
#define DCMChangeExtraStructures_hh
...
class DCMChangeExtraStructures
{
public:
  DCMChangeExtraStructures();
  ~DCMChangeExtraStructures(){};
  ...
  void BuildStructData();

  void ChangeImages();
  void ChangeImagesByStruct();
  void ChangeImagesByLimits();
