...
void DCMPrintValueAlongLine::ReadFilesAndGetImages()
{
  ...
  //---- BUILD DicomLineSet WITH ONE LINE
  ...
  //----- READ LINE LIST FILE and BUILD DicomLineSet 
...
void DCMPrintValueAlongLine::GetInfoFromImages()
{
  for( size_t iimg = 0; iimg < theImages.size(); iimg++ ) {
	...
	G4cout << " DCMPrintValueAlongLine::GetInfoFromImages( n lines " << intersValues.size() << G4endl; //GDEB
