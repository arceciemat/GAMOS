...
//---------------------------------------------------------------------------
void DCMResizeImage::ProcessArguments(int argc,char** argv)
{
  if(argc%2 != 1) {
...
//---------------------------------------------------------------------------
void DCMResizeImage::CheckArguments()
{
}
  
//---------------------------------------------------------------------------
void DCMResizeImage::ReadFilesAndGetImages()
{
