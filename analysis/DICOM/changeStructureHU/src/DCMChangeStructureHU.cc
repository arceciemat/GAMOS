#include "DCMChangeStructureHU.hh"
...
//---------------------------------------------------------------------------
DCMChangeStructureHU::DCMChangeStructureHU()
{
  Initialise();
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::Initialise()
{
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ProcessArguments(int argc,char** argv)
{
  if( argc == 6 ) {
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::CheckArguments()
{
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ReadFilesAndGetImages()
{
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::BuildStructData()
{
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ChangeImages()
{
  if( !bImageLimits ) {
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ChangeImagesByStruct()
{
  //--- LOOP TO VOXELS TO CHANGE MATERIAL OR DENSITY
  G4int nVoxels = theAnalyseImage->GetNoVoxels();
  //  G4cout << " DCMChangeStructureHU::ChangeImagesByStruct " << nVoxels << G4endl; //GDEB
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ChangeVoxelsPartialStruct()
{
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::ChangeImagesByLimits()
{
  G4int nVoxels = theAnalyseImage->GetNoVoxels();
  ...
  //  G4cout << " DCMChangeStructureHU::ChangeImagesByLimits " << nVoxels << G4endl; //GDEB
  for( G4int ii = 0; ii < nVoxels; ii++ ) {
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::WriteNewImage()
{
  //--- DUMP TO FILE
...
//---------------------------------------------------------------------------
void DCMChangeStructureHU::PrintHelp()
{
